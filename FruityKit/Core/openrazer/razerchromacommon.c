...
{
    struct razer_report report = get_razer_report3(0x00, 0x04, 0x02);
...
{
    return get_razer_report3(0x00, 0x84, 0x02);
}
...
{
    return get_razer_report3(0x00, 0x82, 0x16);
}
...
{
    return get_razer_report3(0x00, 0x81, 0x02);
}
...
{
    struct razer_report report = get_razer_report3(0x03, 0x00, 0x03);
...
{
    struct razer_report report = get_razer_report3(0x03, 0x04, 0x04);
    report.arguments[0] = variable_storage;
    report.arguments[1] = led_id;
...
{
    struct razer_report report = get_razer_report3(0x03, 0x80, 0x03);
    report.arguments[0] = variable_storage;
    report.arguments[1] = led_id;
...
{
    struct razer_report report = get_razer_report3(0x03, 0x01, 0x05);
    report.arguments[0] = variable_storage;
    report.arguments[1] = led_id;
...
{
    struct razer_report report = get_razer_report3(0x03, 0x81, 0x05);
    report.arguments[0] = variable_storage;
    report.arguments[1] = led_id;
    return report;
}
...
{
    struct razer_report report = get_razer_report3(0x03, 0x02, 0x03);
    report.arguments[0] = variable_storage;
    report.arguments[1] = led_id;
...
{
    struct razer_report report = get_razer_report3(0x03, 0x82, 0x03);
    report.arguments[0] = variable_storage;
    report.arguments[1] = led_id;
...
{
    struct razer_report report = get_razer_report3(0x03, 0x03, 0x03);
    report.arguments[0] = variable_storage;
    report.arguments[1] = led_id;
...
{
    struct razer_report report = get_razer_report3(0x03, 0x83, 0x03);
    report.arguments[0] = variable_storage;
    report.arguments[1] = led_id;
...
{
    struct razer_report report = get_razer_report3(0x03, 0x0A, 0x01);
...
{
    struct razer_report report = get_razer_report3(0x03, 0x0A, 0x02);
...
{
    struct razer_report report = get_razer_report3(0x03, 0x0A, 0x05);
...
{
    struct razer_report report = get_razer_report3(0x03, 0x0A, 0x04);
...
{
    struct razer_report report = get_razer_report3(0x03, 0x0A, 0x08);
...
struct razer_report razer_chroma_standard_matrix_set_custom_frame(unsigned char row_index, unsigned char start_col, unsigned char stop_col, unsigned char *rgb_data)
{
    ...
    struct razer_report report = get_razer_report3(0x03, 0x0B, 0x46); // In theory should be able to leave data size at max as we have start/stop
...
{
    struct razer_report report = get_razer_report3(0x0F, 0x02, arg_size);
...
{
    struct razer_report report = get_razer_report3(0x0F, 0x04, 0x03);
    report.transaction_id.id = 0x3F;
...
{
    struct razer_report report = get_razer_report3(0x0F, 0x84, 0x03);
    report.transaction_id.id = 0x3F;
...
struct razer_report razer_chroma_extended_matrix_set_custom_frame2(unsigned char row_index, unsigned char start_col, unsigned char stop_col, unsigned char *rgb_data, size_t packetLength)
{
    ...
    struct razer_report report = get_razer_report3(0x0F, 0x03, data_length);
...
{
    struct razer_report report = get_razer_report3(0x03, 0x0D, arg_size);
    report.transaction_id.id = 0x3F;
...
{
    struct razer_report report = get_razer_report3(0x02, 0x06, 0x02);
...
{
    struct razer_report report = get_razer_report3(0x0E, 0x04, 0x02);
...
{
    struct razer_report report = get_razer_report3(0x0E, 0x84, 0x02);
    report.arguments[0] = 0x01;
...
{
    struct razer_report report = get_razer_report3(0x03, 0x0C, 0x32);
    size_t row_length = (size_t) (((stop_col + 1) - start_col) * 3);
...
{
    return get_razer_report3(0x07, 0x80, 0x02);
}
...
{
    return get_razer_report3(0x07, 0x84, 0x02);
}
...
{
    struct razer_report report = get_razer_report3(0x03, 0x10, 0x01);
...
{
    return get_razer_report3(0x00, 0x85, 0x01);
}
...
{
    struct razer_report report = get_razer_report3(0x00, 0x05, 0x01);
...
{
    return get_razer_report3(0x07, 0x82, 0x01);
...
{
    struct razer_report report = get_razer_report3(0x07, 0x02, 0x01);
...
{
    struct razer_report report = get_razer_report3(0x04, 0x05, 0x07);
...
{
    struct razer_report report = get_razer_report3(0x04, 0x85, 0x07);
...
{
    struct razer_report report = get_razer_report3(0x04, 0x01, 0x03);
...
{
    struct razer_report report = get_razer_report3(0x04, 0x81, 0x03);
...
{
    struct razer_report report = get_razer_report3(0x07, 0x03, 0x02);
...
{
    struct razer_report report = get_razer_report3(0x07, 0x01, 0x01);
...
{
    struct razer_report report = get_razer_report3(0x0f, 0x03, 0x0e);
